...
'''
if gbdt:
    lgb_train = lgb.Dataset(X_train, categorical_feature=['date', 'f1', 'f2', 'f3', 'f4', 'f6', 'f7', 'f8', 'f9', 'f10', 'f11', 'f12', 'f13', 'f14', 'f15',
     'f16', 'f17', 'f18', 'f19'])
    lgb_test = lgb.Dataset(X_test, reference=lgb_train, categorical_feature=['date', 'f1', 'f2', 'f3', 'f4', 'f6', 'f7', 'f8', 'f9', 'f10', 'f11', 'f12', 'f13', 'f14', 'f15',
     'f16', 'f17', 'f18', 'f19'])
    params = {
        'boosting': 'gbdt',
        'metric': 'auc',
    ...
    df = pd.DataFrame(df_train.columns.tolist(), columns=['feature'])
